...
import cn.edu.xmu.javaee.productdemoaop.mapper.manual.ProductAllMapperByJoin;
import cn.edu.xmu.javaee.productdemoaop.mapper.manual.ProductAllMapperByJoin11;
import cn.edu.xmu.javaee.productdemoaop.mapper.manual.ProductAllMapperByJoin12;
...
public class ProductDao {
    ...
    private ProductAllMapperByJoin productAllMapperByJoin;

    private ProductAllMapperByJoin11 productAllMapperByJoin11;

    private ProductAllMapperByJoin12 productAllMapperByJoin12;

    @Autowired
    public ProductDao(ProductPoMapper productPoMapper, OnSaleDao onSaleDao, ProductAllMapper productAllMapper,ProductAllMapperByJoin productAllMapperByJoin,
                      ProductAllMapperByJoin11 productAllMapperByJoin11,ProductAllMapperByJoin12 productAllMapperByJoin12) {
        this.productPoMapper = productPoMapper;
        this.onSaleDao = onSaleDao;
        this.productAllMapper = productAllMapper;
        this.productAllMapperByJoin = productAllMapperByJoin;
        this.productAllMapperByJoin11= productAllMapperByJoin11;
        this.productAllMapperByJoin12 = productAllMapperByJoin12;
    }
    ...
    public List<Product> findProductByName_manual_Join(String name) throws BusinessException {
        List<Product> productList;
        List<ProductAllPo> productPoList = productAllMapperByJoin.getProductWithAllByJoin(name);
        productList =  productPoList.stream().map(o->CloneFactory.copy(new Product(), o)).collect(Collectors.toList());
        logger.debug("findProductByName_manual: productList = {}", productList);
        return productList;
    }

    public List<Product> findProductByName_manual_Join11(String name) throws BusinessException {
        List<Product> productList;
        List<ProductAllPo> productPoList = productAllMapperByJoin11.getProductWithAllByJoin11(name);
        productList =  productPoList.stream().map(o->CloneFactory.copy(new Product(), o)).collect(Collectors.toList());
        logger.debug("findProductByName_manual: productList = {}", productList);
        return productList;
    }

    public List<Product> findProductByName_manual_Join12(String name) throws BusinessException {
        List<Product> productList;
        List<ProductAllPo> productPoList = productAllMapperByJoin12.getProductWithAllByJoin12(name);
        productList =  productPoList.stream().map(o->CloneFactory.copy(new Product(), o)).collect(Collectors.toList());
        logger.debug("findProductByName_manual: productList = {}", productList);
        return productList;
    }
